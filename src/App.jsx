...
export default function App() {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'linear-gradient(135deg,#534AB7 0%,#185FA5 100%)', display:'flex', alignItems:'center', justifyContent:'center', fontFamily:'-apple-system,BlinkMacSystemFont,sans-serif', padding:'20px' }}>
      <div style={{ background:'white', borderRadius:'28px', padding:'24px 24px', width:'100%', maxWidth:'380px', boxShadow:'0 20px 60px rgba(0,0,0,0.3)', overflowY:'auto', maxHeight:'90vh' }}>
        <div style={{ textAlign:'center', marginBottom:'24px' }}>
          <div style={{ fontSize:'34px', fontWeight:'800', color:'#534AB7', fontFamily:'Space Grotesk, sans-serif', letterSpacing:'-1px', marginBottom:'4px' }}>Syng</div>
