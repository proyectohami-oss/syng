/**
 * NotifPrefsSection — notificaciones + instalación PWA.
 */
      ...
      <div style={card}>
        ...
        {isSupported && permissionState === 'denied' && (
          <div style={alertBox}>
            ...
            <div>
              <p style={{ margin: 0, fontSize: 14, fontWeight: 600, color: '#7c2d12' }}>
        ...
        {isSupported && permissionState === 'default' && (
          <>
            ...
            <button
              ...
              disabled={activating}
              style={{ ...btnPrimary, opacity: activating ? 0.7 : 1 }}
            >
        ...
        {isSupported && permissionState === 'granted' && (
          <>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
              <div>
                <p style={{ margin: 0, fontSize: 15, fontWeight: 600, color: '#0D1240' }}>
                  Resumen diario
                </p>
...
const btnPrimary = { width: '100%', minHeight: 50, borderRadius: 14, border: 'none', background: 'linear-gradient(135deg, #3D4FA8 0%, #2D3A8C 100%)', color: '#fff', fontSize: 15, fontWeight: 700, cursor: 'pointer', transition: 'opacity 0.15s ease' }
